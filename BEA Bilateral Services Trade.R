...
# Objective:  From the BEA API, download services trade data for a given country
...
# Example call: U.S.-Germany bilateral services trade, 2012-2017

Germany_services_12_17 <- services_call("Germany", bea_key, "2012", "2017")
